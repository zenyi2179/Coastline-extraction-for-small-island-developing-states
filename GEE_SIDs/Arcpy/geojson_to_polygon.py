...
def geojson_to_polygon(extract_geojson, tolerance, coast_line_shp):
    ...
    unique_id = fr"'{temp_unique_id.split('_')[0]}'"
...
if __name__ == '__main__':
    # 全局环境设置
    # geojson_to_polygon(
    #     extract_geojson=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Geojson\60W53S_extract.geojson",
    #     tolerance=15,  # 平滑的容差（米）
    #     coast_line_shp=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Landsat_output\YY_2015\60W53S_extract.shp"
    # )
    # E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Geojson\43E25S_extract.geojson
    geojson_to_polygon(
        extract_geojson=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Geojson\67W56S_extract.geojson",
        tolerance=15,  # 平滑的容差（米）
        coast_line_shp=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Landsat_output\YY_2015\67W56S_extract.shp"
    )