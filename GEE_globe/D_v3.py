...
# E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Filtering\60W53S_filtered.tif
if __name__ == '__main__':
    # # 执行子像素提取，并生成 GeoJSON 文件
    # subpixel_extraction(
    #     input_tif=fr'E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Filtering\UID_38020_filtered.tif',
    #     z_values=10,
    #     subpixel_tif=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Geojson\UID_38020_extract.geojson"
    # )
    # 执行子像素提取，并生成 GeoJSON 文件
    # subpixel_extraction(
    #     input_tif=fr'E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Filtering\67W56S_filtered.tif',
    #     z_values=10,
    #     subpixel_tif=fr"E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Geojson\67W56S_extract.geojson"
    # )
    subpixel_extraction(
        input_tif=fr'C:\Users\23242\Desktop\check\250412\FSM\FSM_test.tif',
        z_values=0,
        subpixel_tif=fr"C:\Users\23242\Desktop\check\250412\FSM\FSM_test.geojson"
    )
