...
if __name__ == '__main__':
    ...
    # )
    filter_image(
        filter_input_path=fr'E:\_GoogleDrive\_DGS_GSV_Landsat\48W25S_MNDWI.tif',
        filter_output_path=fr'E:\_OrderingProject\F_IslandsBoundaryChange\b_ArcData\GEE_Filtering\48W25S_filtered.tif'
    )