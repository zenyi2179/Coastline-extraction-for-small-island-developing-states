...
if __name__ == '__main__':
    # 调用函数应用高斯滤波
    input_image_path = r'E:\_GoogleDrive\_DGS_GSV_Landsat\UID_36584_MNDWI.tif'
    ...
    gaussian_filtered_image = apply_gaussian_filter(input_image_path, sigma=0.5, output_path=temp_output_image_path)
    ...
    print(f"过滤椒盐噪声已保存到: {output_image_path}")
