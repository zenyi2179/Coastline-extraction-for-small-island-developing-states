...
if __name__ == '__main__':
    # 定义 TIFF 文件路径
    # tif_file = fr'E:\_OrderingProject\20367_ND2_zoom.tif'
    tif_file = r'C:\Users\23242\Desktop\check\reference.tif'
    subpixel_tif = fr"C:\Users\23242\Desktop\check\reference.geojson"

    # name = 'ND2_mal4_3'
    # tif_file = fr'F:\马尔代夫四波段影像\ND2\{name}.tif'  # 输入图像路径
    # subpixel_tif = fr'F:\马尔代夫四波段影像\SubPixelExtraction\Ext_{name}.geojson'  # 输出图像路径
