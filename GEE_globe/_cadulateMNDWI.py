...
if __name__ == '__main__':
    # 调用函数
    # input_path = fr'E:\_OrderingProject\20367.tif'  # 输入图像路径
    # output_path = fr'E:\_OrderingProject\20367_ND2.tif'  # 输出图像路径
    # band1 = 1  # SR_B3 波段索引
    # band2 = 2  # SR_B6 波段索引

    input_path = fr'F:\马尔代夫四波段影像\mal4_3.tif'  # 输入图像路径
    output_path = fr'F:\马尔代夫四波段影像\ND2\\ND2_' + input_path.split('\\')[-1]  # 输出图像路径
    band1 = 2  # SR_B3 波段索引
    band2 = 4  # SR_B6 波段索引
    ...
    #    D:\ArcGISPro3\Pro\bin\Python\envs\arcgispro-py3\python.exe -m pip install --user  dea-tools -i https://pypi.doubanio.com/simple/
