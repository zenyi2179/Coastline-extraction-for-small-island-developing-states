...
if __name__ == '__main__':
    ...
    for sid in sid_list:
        for year in [2015]:
            # Execute
            fix_shp = fr"E:\_OrderingProject\F_IslandsBoundaryChange\g_QGIS\a_SIDS_Shp_Merge\{sid}\{sid}_{str(year)[-2:]}.shp"
            add_shp = fr"E:\_OrderingProject\F_IslandsBoundaryChange\g_QGIS\a_SIDS_Shp_Merge\{sid}\add.shp"
            ...
            arcpy.analysis.PairwiseDissolve(temp_merge_shp, out_feature_class)
