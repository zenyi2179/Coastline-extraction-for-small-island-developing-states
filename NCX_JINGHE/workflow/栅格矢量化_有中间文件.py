    ...
    for year in list_year:
        ...
        try:
            ...
            for tif_gee in list_tif:
                ...
                path_geojson = os.path.join(path_base, f'subpixel_extraction', geojson_name)  # geojson文件路径
                ...
                path_polygon = os.path.join(path_base, f'geojson_to_polygon', polygon_name)  # shp文件路径
